...
- ### ¿Que datos se guardan?
  ...
  las estadísticas históricas personales de jugador:  
    ...
    6. cantidad de de faltas acumuladas.
...
- [ ] Crear/Corregir la clase Jugador (incluir: numero de camiseta, nombre/apellido generico y los 7 contadores de estadisticas).
